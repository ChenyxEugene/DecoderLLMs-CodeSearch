...
def main():
    ...
    if accelerator.is_main_process:
        ...
        logger.info(f"  - Language to Discard:        {data_args.discard_language}")
        logger.info(f"  - Discard Ratio:              {data_args.discard_ratio}")
        logger.info("-" * 80)
    ...
    train_dataset = load_dataset(
        ...
        * accelerator.num_processes,
        discard_language=data_args.discard_language,
        discard_ratio=data_args.discard_ratio,
    )
